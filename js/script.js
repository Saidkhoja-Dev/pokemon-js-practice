...
let unOrdinaryList = document.querySelector(".list");

function renderPokemons(p) {

    for (let i = 0; i < pokemons.length; i++) {

        let elListItem = document.createElement("li");
        unOrdinaryList.appendChild(elListItem);
        elListItem.classList.add("card")

        let img = document.createElement("img");
        elListItem.appendChild(img);
        img.src = pokemons[i]["img"];
        img.weight = 80;
        img.height = 150;

        let headingTwo = document.createElement("h2");
        elListItem.appendChild(headingTwo);
        headingTwo.textContent = pokemons[i]["name"];
        headingTwo.classList.add("text-center","text-black")

        let paragraphType = document.createElement("p");
        elListItem.appendChild(paragraphType);
        paragraphType.textContent = pokemons[i]["type"];

        paragraphType.classList.add("text-center","text-bold")

        let strongWeight = document.createElement("strong");
        elListItem.appendChild(strongWeight);
        strongWeight.textContent  = pokemons[i]["weight"];

        strongWeight.classList.add("text-center","text-bold")

        let strongHeight = document.createElement("strong");
        elListItem.appendChild(strongHeight);
        strongHeight.textContent  = pokemons[i]["height"];

        strongHeight.classList.add("text-center","text-bold");
    }
}
...
function myFunction() {
        dom.style.background = `linear-gradient(${Math.ceil(Math.random() * 360)}deg, rgba(${Math.ceil(Math.random() * 255)}, ${Math.ceil(Math.random() *255)}, ${Math.ceil(Math.random() *255)}),rgba(${Math.ceil(Math.random() * 255)}, ${Math.ceil(Math.random() * 255)}, ${Math.ceil(Math.random() * 255)}),rgba(${Math.ceil(Math.random() * 255)}, ${Math.ceil(Math.random() * 255)}, ${Math.ceil(Math.random() * 255)})`;
}
myFunction()
let myinterval = setInterval(myFunction, 500);
